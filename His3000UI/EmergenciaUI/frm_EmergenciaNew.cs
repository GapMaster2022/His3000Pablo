...
{
    public partial class frm_EmergenciaNew : Form
    {
        ...
        PACIENTES_DATOS_ADICIONALES2 datosPacienteActualDA = null;
        ...
        public frm_EmergenciaNew(int codatencion)
        {
            // mostrarinfpaciente = true;
            InitializeComponent();
            // this.codatencion = 199182;
        ...
        private void LimpiarCamposEmergencia()
        {
            ...
            chb_ValorAlcocheck.Checked = false;
            chkAltDef.Checked = false;
            txtObsExaFis.Text = "";
            chk_CausaC.Checked = false;
            chk_CausaGOb.Checked = false;
            chk_CausaQuir.Checked = false;
            txt_OtroMotivo.Text = "";
            ////aumento campos formulario 2021 cprl 20240222
            txtMotivoAtencion.Text = "";
            txtScore.Text = "";
            radioCLlegadaEstable.Checked = false;
            radioCLlegadaInestable.Checked = false;
            radioCLlegadaFallecido.Checked = false;
            ///
            ...
            txt_DiamPDV.Text = "";
            cmb_ReacPDValor.SelectedIndex = 3;
            //chk_DiamPI.Checked = false;
            //chk_ReacPI.Checked = false;
            txt_DiamPIV.Text = "";
            cmb_ReacPIValor.SelectedIndex = 3;
            //txt_Glicemia.Text = "0";
            ...
            txtObservacion.Text = "";
            chkHospitalizacion.Checked = false;
            chkRefInv.Checked = false;
        ...
        private void CargarDatos()
        {
            ...
            List<HC_CATALOGOS> nuevaListaDestino = listaDestino.Where(item => item.HCC_NOMBRE != "REFERENCIA").ToList();

            // Asignar la nueva lista como DataSource del ComboBox
            cmb_Destino.DataSource = nuevaListaDestino;
            ...
            txtFechaI.Text = atencionActual.ATE_FECHA_INGRESO.ToString().Substring(0, 10);
        ...
        private void CargarDatosAdicionalesPaciente(int keyPaciente)
        {
            try
            {
                ...
                if (datosPacienteActual != null)
                {
                    ...
                    txtCalleSecundaria.Text = datosPacienteActual.DAP_DIRECCION_DOMICILIO2;
                    txtReferencia.Text = datosPacienteActual.DAP_REFERENCIA;
            ...
            if (atencionActual != null)
            {
                ...
                if (emergenciaActual != null)
                {
                    ...
                    if (signos.Rows.Count > 0)
                    {
                        ...
                        enteros = signos.Rows[0][26].ToString();
                        final = enteros.Split('.');
                        txtLleCap.Text = signos.Rows[0][26].ToString();
                    }
                ...
                else
                {
                    ...
                    if (obstet.Rows.Count > 0)
                    {
                        ...
                        dtp_ultimaMenst11.Value = Convert.ToDateTime(obstet.Rows[0][7].ToString());
        ...
        private void CargarCamposEmergencia(HC_EMERGENCIA_FORM emergenciaM)
        {
            ...
            txtLleCap.Text = emergenciaM.EMER_LLE_CAP;
            txtObservacion.Text = emergenciaM.EMER_OBS_EGR;
            if (emergenciaM.EMER_ACT_TRA == 1)
                chkAccTra.Checked = true;
            else
                chkAccTra.Checked = false;

            if (emergenciaM.EMER_VIO_ARM == 1)
                chkVioArm.Checked = true;
            else
                chkVioArm.Checked = false;
            if (emergenciaM.EMER_INT_ALC == 1)
                chkIntAlc.Checked = true;
            else
                chkIntAlc.Checked = false;
            if (emergenciaM.EMER_INT_ALC == 1)
                chkIntAlc.Checked = true;
            else
                chkIntAlc.Checked = false;
            if (emergenciaM.EMER_CAIDA == 1)
                chkCaida.Checked = true;
            else
                chkCaida.Checked = false;
            if (emergenciaM.EMER_VIO_PUN == 1)
                chkVioPun.Checked = true;
            else
                chkVioPun.Checked = false;
            if (emergenciaM.EMER_INT_ALI == 1)
                chkIntAli.Checked = true;
            else
                chkIntAli.Checked = false;
            if (emergenciaM.EMER_QUEMADURA == 1)
                chkQuemadura.Checked = true;
            else
                chkQuemadura.Checked = false;
            if (emergenciaM.EMER_VIO_RINA == 1)
                chkVioRin.Checked = true;
            else
                chkVioRin.Checked = false;
            if (emergenciaM.EMER_INT_DRO == 1)
                chkIntDro.Checked = true;
            else
                chkIntDro.Checked = false;
            if (emergenciaM.EMER_MORDEDURA == 1)
                chkMordedura.Checked = true;
            else
                chkMordedura.Checked = false;
            if (emergenciaM.EMER_VIO_FAM == 1)
                chkVioFam.Checked = true;
            else
                chkVioFam.Checked = false;
            if (emergenciaM.EMER_INH_GAS == 1)
                chkInhGas.Checked = true;
            else
                chkInhGas.Checked = false;
            if (emergenciaM.EMER_AHOGAMIENTO == 1)
                chkAhogamiento.Checked = true;
            else
                chkAhogamiento.Checked = false;

            if (emergenciaM.EMER_PRE_FIS == 1)
                chkPreFis.Checked = true;
            else
                chkPreFis.Checked = false;
            if (emergenciaM.EMER_OTR_INT == 1)
                chkOtrInt.Checked = true;
            else
                chkOtrInt.Checked = false;
            if (emergenciaM.EMER_CUE_EXT == 1)
                chkCueExt.Checked = true;
            else
                chkCueExt.Checked = false;
            if (emergenciaM.EMER_PRE_PSI == 1)
                chkPrePsi.Checked = true;
            else
                chkPrePsi.Checked = false;

            if (emergenciaM.EMER_PICADURA == 1)
                chkPicadura.Checked = true;
            else
                chkPicadura.Checked = false;
            if (emergenciaM.EMER_APLASTAMIENTO == 1)
                chkAplastamiento.Checked = true;
            else
                chkAplastamiento.Checked = false;
            if (emergenciaM.EMER_PRE_SEX == 1)
                chkPreSex.Checked = true;
            else
                chkPreSex.Checked = false;
            if (emergenciaM.EMER_ENVENENAMIENTO == 1)
                chkEnvenenamiento.Checked = true;
            else
                chkEnvenenamiento.Checked = false;
            if (emergenciaM.EMER_OTR_ACC == 1)
                chkOtrAcc.Checked = true;
            else
                chkOtrAcc.Checked = false;
            if (emergenciaM.EMER_NOTIFICACION == 1)
                chkNotificacion.Checked = true;
            else
                chkNotificacion.Checked = false;
            if (emergenciaM.EMER_ANAFILAXIA == 1)
                chkAnafilaxia.Checked = true;
            else
                chkAnafilaxia.Checked = false;
            /////
            if (emergenciaM.EMER_CUSTODIA_POLICIAL == true)
                chk_CustodiaPolicial.Checked = true;
            else
                chk_CustodiaPolicial.Checked = false;
            cmb_Accidentes.SelectedItem = listaAccidentes.FirstOrDefault(a => a.HCC_CODIGO == emergenciaM.HCC_CODIGO_AVIEQ);
            ...
            //
            txtMotivoAtencion.Text = emergenciaM.EMER_CL_MOTIVO;
            txtScore.Text = emergenciaM.EMER_SCORE.ToString();

            if (emergenciaM.EMER_CL_ESTABLE == null || emergenciaM.EMER_CL_ESTABLE == 0)
            {
                radioCLlegadaEstable.Checked = false;
            }
            else
            {
                radioCLlegadaEstable.Checked = true;
            }
            if (emergenciaM.EMER_CL_INESTABLE == null || emergenciaM.EMER_CL_INESTABLE == 0)
            {
                radioCLlegadaInestable.Checked = false;
            }
            else
            {
                radioCLlegadaInestable.Checked = true;
            }
            if (emergenciaM.EMER_CL_FALLECIDO == null || emergenciaM.EMER_CL_FALLECIDO == 0)
            {
                radioCLlegadaFallecido.Checked = false;
            }
            else
            {
                radioCLlegadaFallecido.Checked = true;
            }
            ...
            txtLleCap.Text = emergenciaM.EMER_LLE_CAP?.ToString() ?? "";
            txt_PerimetroC.Text = emergenciaM.EMER_PERIMETRO?.ToString() ?? "";
            txtObsExaFis.Text = emergenciaM.EMER_OBS_EXA_FIS?.ToString() ?? "";
            if (emergenciaM.EMER_ALT_DEF == 1)
                chkAltDef.Checked = true;
            else
                chkAltDef.Checked = false;

            if (emergenciaM.EMER_GRU_PRIO == 1)
            {
                radioButton22.Checked = true;
                cmbDPrioritario.Text = emergenciaM.EMER_PRIORITARIO;
            }
            else
            {
            ...
            if (emergenciaM.EMER_SIN_VIT == 1)
                chkSinCon.Checked = true;
            else
                chkSinCon.Checked = false;
            ...
            if (emergenciaM.EMER_PUP_DIAD.ToString() != "-1")
            {
            ...
            if (emergenciaM.EMER_PUP_DIAI.ToString() != "-1")
        ...
        private void cargarExamenFisico()
        {
            try
            {
                ...
                //tipo_Examen.DataSource = ant2N;// Se comenta para no ocupar combo solicitado pro clinica Pasteur // Mario Valencia // 21-03-2024
        ...
        private void cargarDetalles()
        {
            ...
            if (detalles != null)
            {
                ...
                {
                    DataGridViewRow fila = new DataGridViewRow();
                    DataGridViewTextBoxCell cmbcell = new DataGridViewTextBoxCell();
            ...
            if (examenes != null)
            {
                ...
                foreach (HC_EMERGENCIA_FORM_EXAMENFISICOD exa in examenes)
                {
                    ...
                    DataGridViewTextBoxCell cmbcell1 = new DataGridViewTextBoxCell();
        ...
        private void cargarTratamientosMedicamentos()
        {
            ...
            if (listaMedicamentos != null)
            {
                ...
                foreach (HC_EMERGENCIA_FORM_TRATAMIENTO med in listaMedicamentos)
                {
                    ...
                    DataGridViewTextBoxCell ViaCell = new DataGridViewTextBoxCell();
                    DataGridViewTextBoxCell DosisCell = new DataGridViewTextBoxCell();
                    DataGridViewTextBoxCell PosologiaCell = new DataGridViewTextBoxCell();
                    DataGridViewTextBoxCell DiasCell = new DataGridViewTextBoxCell();
                    ...
                    ViaCell.Value = med.VIA;
                    DosisCell.Value = med.DOSIS;
                    DiasCell.Value = med.DIAS;

                    fila.Cells.Add(codigoCell);
                    fila.Cells.Add(CodigoPcell);
                    fila.Cells.Add(textcell);

                    fila.Cells.Add(ViaCell);
                    fila.Cells.Add(DosisCell);
                    fila.Cells.Add(PosologiaCell);
                    fila.Cells.Add(DiasCell);
            ...
            try
            {
                if (emergenciaActual != null)
                {
                    ...
                    if (eObst != null)
                    {
                        ...
                        dtp_ultimaMenst11.Value = eObst.EOBT_FUM.Value;
                        if (dtp_ultimaMenst11.Value == new DateTime(1900, 1, 1))
                        {
                            dtp_ultimaMenst11.Checked = false;
                        }
        ...
        public void GuardarEmergencia()
        {
            try
            {
                ...
                ///campos nuevo formulario 2021
                emergenciaActual.EMER_CL_MOTIVO = txtMotivoAtencion.Text;

                if (txtScore.Text != "")
                {
                    emergenciaActual.EMER_SCORE = Convert.ToInt32(txtScore.Text);
                }
                else
                {
                    emergenciaActual.EMER_SCORE = Convert.ToInt32(0);
                }

                if (radioCLlegadaEstable.Checked == true)
                    emergenciaActual.EMER_CL_ESTABLE = 1;
                else
                    emergenciaActual.EMER_CL_ESTABLE = 0;
                if (radioCLlegadaInestable.Checked == true)
                    emergenciaActual.EMER_CL_INESTABLE = 1;
                else
                    emergenciaActual.EMER_CL_INESTABLE = 0;
                if (radioCLlegadaFallecido.Checked == true)
                    emergenciaActual.EMER_CL_FALLECIDO = 1;
                else
                    emergenciaActual.EMER_CL_FALLECIDO = 0;
                ...
                emergenciaActual.EMER_DIRECCION_EVENTO = txt_DireccionEvento.Text;
                ///
                emergenciaActual.EMER_ACT_TRA = chkAccTra.Checked ? 1 : 0;
                emergenciaActual.EMER_VIO_ARM = chkVioArm.Checked ? 1 : 0;
                emergenciaActual.EMER_INT_ALC = chkIntAlc.Checked ? 1 : 0;
                emergenciaActual.EMER_CAIDA = chkCaida.Checked ? 1 : 0;
                emergenciaActual.EMER_VIO_PUN = chkVioPun.Checked ? 1 : 0;
                emergenciaActual.EMER_INT_ALI = chkIntAli.Checked ? 1 : 0;
                emergenciaActual.EMER_QUEMADURA = chkQuemadura.Checked ? 1 : 0;
                emergenciaActual.EMER_VIO_RINA = chkVioRin.Checked ? 1 : 0;
                emergenciaActual.EMER_INT_DRO = chkIntDro.Checked ? 1 : 0;
                emergenciaActual.EMER_MORDEDURA = chkMordedura.Checked ? 1 : 0;
                emergenciaActual.EMER_VIO_FAM = chkVioFam.Checked ? 1 : 0;
                emergenciaActual.EMER_INH_GAS = chkInhGas.Checked ? 1 : 0;
                emergenciaActual.EMER_AHOGAMIENTO = chkAhogamiento.Checked ? 1 : 0;
                emergenciaActual.EMER_PRE_FIS = chkPreFis.Checked ? 1 : 0;
                emergenciaActual.EMER_OTR_INT = chkOtrInt.Checked ? 1 : 0;
                emergenciaActual.EMER_CUE_EXT = chkCueExt.Checked ? 1 : 0;
                emergenciaActual.EMER_PRE_PSI = chkIntAlc.Checked ? 1 : 0;
                emergenciaActual.EMER_PICADURA = chkPicadura.Checked ? 1 : 0;
                emergenciaActual.EMER_APLASTAMIENTO = chkAplastamiento.Checked ? 1 : 0;
                emergenciaActual.EMER_PRE_SEX = chkPreSex.Checked ? 1 : 0;
                emergenciaActual.EMER_ENVENENAMIENTO = chkEnvenenamiento.Checked ? 1 : 0;
                emergenciaActual.EMER_OTR_ACC = chkOtrAcc.Checked ? 1 : 0;
                emergenciaActual.EMER_NOTIFICACION = chkNotificacion.Checked ? 1 : 0;
                emergenciaActual.EMER_ANAFILAXIA = chkAnafilaxia.Checked ? 1 : 0;
                emergenciaActual.EMER_SIN_VIT = chkSinCon.Checked ? 1 : 0;
                emergenciaActual.EMER_LLE_CAP = txtLleCap.Text;
                emergenciaActual.EMER_PERIMETRO = txt_PerimetroC.Text;
                emergenciaActual.EMER_HOSPITALIZACION = chkHospitalizacion.Checked ? 1 : 0;
                emergenciaActual.EMER_REF_INV = chkRefInv.Checked ? 1 : 0;
                emergenciaActual.EMER_OBS_EGR = txtObservacion.Text;
                emergenciaActual.EMER_PRIORITARIO = cmbDPrioritario.Text;
                ...
                {
                    emergenciaActual.EMER_GRU_PRIO = 1;
                }
                else
                {
                    emergenciaActual.EMER_GRU_PRIO = 0;
                }
                emergenciaActual.EMER_DERIVACION = chkDerivacion.Checked ? 1 : 0;
                emergenciaActual.EMER_ALT_DEF = chkAltDef.Checked ? 1 : 0;
                ///
                ...
                else
                {
                    ...
                    emergenciaActual.EMER_INTER = false;
                }
                ...
                else
                {
                    if (accion == "UPDATE")
                    {
                        NegHcEmergenciaForm.ModificarHCEmergenciaFNEW(emergenciaActual);
                        GuardarObservacionGeneral(atencionActual.ATE_CODIGO);
                        NegHcEmergenciaForm emer = new NegHcEmergenciaForm();
                        emer.GuardarGrupoS(pacienteActual.PAC_CODIGO, Convert.ToInt32(txt_GSanguineo.SelectedValue));
                        GuardarDetalles();
        ...
        private void GuardarEmergenciaObstetrica()
        {
            try
            {
                ...
                if (chk_CausaGOb.Checked == false || chk_CausaGOb.Checked == true)
                {
                    bool valor = false;
                    if (eObst == null)
                    {
                    ...
                    if (dtp_ultimaMenst11.Checked == true)
                    {
                        eObst.EOBT_FUM = dtp_ultimaMenst11.Value;
                    }
                    else
                    {
                        eObst.EOBT_FUM = Convert.ToDateTime("01/01/1900");
                        dtp_ultimaMenst11.Checked = false;
                    }

                    eObst.EOBT_SEM_GESTACION = dtp_ultimaMenst11.Checked == true ? txt_SemanaG.Text : "";
                ...
                foreach (DataGridViewRow fila in dgv_Medicamentos.Rows)
                {
                    if (fila != null)
                    {
                        if (fila.Cells[1].Value != null)
                        {
                            ...
                            {
                                med.VIA = fila.Cells[3].Value.ToString();
                                med.DOSIS = fila.Cells[4].Value.ToString();
                                med.EMER_POSOLOGIA = fila.Cells[5].Value.ToString();
                                med.DIAS = fila.Cells[6].Value.ToString();
        ...
        private void LimpiarCamposAccidentes()
        {
            ...
            dgv_LocalizacionL.Rows.Clear();
            gpb_Localizacion1.Enabled = false;
            txt_OtrasL.Text = "";
        }
        ...
        private void LimpiarCamposObstetricos()
        {
            ...
            txt_Abortos.Text = "";
            txt_Cesareas.Text = "";
            dtp_ultimaMenst11.Value = DateTime.Now;
            txt_SemanaG.Text = "";
        ...
        private void chk_Trauma_CheckedChanged(object sender, EventArgs e)
        {
            if (chk_Trauma.Checked == true)
            {
                ...
                gpb_Localizacion1.Enabled = true;
        ...
        {
            if (cmb_Destino.Text == "DOMICILIO" || cmb_Destino.Text == "OBSERVACIÓN")
            {
        ...
        private bool ValidarCampos()
        {
            ...
            if (radioButton22.Checked == true)
            {
                ...
                if (cmbDPrioritario.Text == "NINGUNO")
                {
                    error.SetError(cmbDPrioritario, "Debe seleccionar un grupo prioritario.");
                    accion = true;
                }
            }
            ...
            if (dtp_ultimaMenst11.Value.Date > DateTime.Now.Date)
            {
                error.SetError(dtp_ultimaMenst11, "Fecha de ultima menstruación no puede ser mayor a fecha actual.");
                accion = true;
            }
        ...
        private bool ValidarCampos2()
        {
            ...
            Int32 edad = 0;
            edad = Convert.ToInt16((txtEdad.Text.Substring(0, 2)));
            if (edad >= 14 && chkSinCon.Checked == false)
            {
            ...
            //if(cmb_ReacPDValor.SelectedIndex == 3)
            //{
            //    AgregarError(cmb_ReacPDValor);

            //    accion = true;
            //}
            //if (cmb_ReacPIValor.SelectedIndex == 3)
            //{
            //    AgregarError(cmb_ReacPIValor);

            //    accion = true;
            //}


            if (radioCLlegadaEstable.Checked == false && radioCLlegadaFallecido.Checked == false && radioCLlegadaInestable.Checked == false)
            {
                AgregarError(groupBox29);
                accion = true;
            }
            ...
            if (txtMotivoAtencion.Text == "")
            {
                AgregarError(txtMotivoAtencion);
                accion = true;
            }
            //if (txt_DireccionEvento.Text == "")
            //{
            //    AgregarError(txt_DireccionEvento);
            //    accion = true;
            //}

            if (dtg_antec_personales.Rows.Count == 1)/*  este campo no es obligatorio / Giovanny Tapia / 01/04/2013  */
            {
            ...
            if (txt_EnfermedadActual.Text == "")
            {
                AgregarError(txt_EnfermedadActual);
                accion = true;
            }
            //if (dgv_ExamenesS.Rows.Count >= 1)/*  este campo no es obligatorio / Giovanny Tapia / 01/04/2013  */
            //{
            //    int i = 0;
            //    for (i = 0; i < dgv_ExamenesS.Rows.Count - 1; i++)
            //    {
            //        if (dgv_ExamenesS.Rows[i].Cells[1].Value == null)
            //        {
            //            AgregarError(dgv_ExamenesS);
            //            accion = true;
            //        }
            //    }
            //}
            ...
            //    accion = true;
            //}
            if (dtg_ExamenFisico.Rows.Count == 1)/*  este campo no es obligatorio / Giovanny Tapia / 01/04/2013  */
            {
                //    int i = 0;
                //    for (i = 0; i < dgv_ExamenesS.Rows.Count - 1; i++)
                //    {
                //        if (dtg_ExamenFisico.Rows[i].Cells[1].Value == null)
                //        {
            ...
            //if (dtg_DiagnosticosAlta.Rows.Count == 0)/*  este campo no es obligatorio / Giovanny Tapia / 01/04/2013  */
            //{
            //    AgregarError(dtg_DiagnosticosAlta);
            //    accion = true;
            //}
            ...
            //if (dtg_DiagnosticosI.Rows.Count == 0)/*  este campo no es obligatorio / Giovanny Tapia / 01/04/2013  */
            //{
            ...
            {
                //    int i = 0;
                //    for (i = 0; i < dgv_Indicaciones.Rows.Count - 1; i++)
                //    {
                //        if (dgv_Indicaciones.Rows[i].Cells[1].Value == null)
                //        {
                //            AgregarError(dgv_Indicaciones);
            ...
            if (radioButton22.Checked == true)
            {
                ...
                if (cmbDPrioritario.Text == "NINGUNO" || cmbDPrioritario.SelectedItem == null)
                {
                    error.SetError(cmbDPrioritario, "Debe seleccionar un grupo prioritario.");
                    accion = true;
                }
            ...
            if (dtg_DiagnosticosI.Rows.Count >= 1)/*  este campo no es obligatorio / Giovanny Tapia / 01/04/2013  */
            {
                int i = 0;
                for (i = 0; i < dtg_DiagnosticosI.Rows.Count - 1; i++)
                {
                    if (dtg_DiagnosticosI.Rows[i].Cells[1].Value == null)
                    {
                        AgregarError(dtg_DiagnosticosI);
                        accion = true;
                    }
            ...
            if (dtg_DiagnosticosAlta.Rows.Count >= 1)/*  este campo no es obligatorio / Giovanny Tapia / 01/04/2013  */
            {
                int i = 0;
                for (i = 0; i < dtg_DiagnosticosAlta.Rows.Count - 1; i++)
                {
                    if (dtg_DiagnosticosAlta.Rows[i].Cells[1].Value == null)
                    {
                        AgregarError(dtg_DiagnosticosAlta);
                        accion = true;
                    }
        ...
        public void Imprimir()
        {
            ...
            datosPacienteActualDA = NegPacienteDatosAdicionales.pacientesdatos2(pacienteActual.PAC_CODIGO);
            ...
            List<HC_EMERGENCIA_FORM_TRATAMIENTO> listaIndicaciones = NegHcEmergenciaFDetalle.recuperarTratameinto(emergenciaActual.EMER_CODIGO, "I");
            List<HC_EMERGENCIA_FORM_TRATAMIENTO> listaMedicamentos = NegHcEmergenciaFDetalle.recuperarTratameinto(emergenciaActual.EMER_CODIGO, "M");
            List<NACIONALIDAD_ETNIA> Lisnetnias = NegEtnias.ListaNacionalidadEtnica();
            #region CABECERA
            ...
            dr["Codigo"] = His.Entidades.Clases.Sesion.unicodigo;
            if (datosPacienteActual.COD_SECTOR != null)
            {
                ...
                dr["Barrio"] = !string.IsNullOrEmpty(dp.DIPO_NOMBRE) ? dp.DIPO_NOMBRE : "N/A";
            }
            else
                dr["Barrio"] = "N/A";
            if (datosPacienteActual.COD_PARROQUIA != null)
            {
                ...
                dr["Parroquia1"] = dp.DIPO_NOMBRE;
                dr["Parroquia1"] = !string.IsNullOrEmpty(dp.DIPO_NOMBRE) ? dp.DIPO_NOMBRE : "N/A";
            }
            else
                dr["Parroquia1"] = "N/A";
            if (datosPacienteActual.COD_CANTON != null)
            {
                ...
                dr["Canton1"] = !string.IsNullOrEmpty(dp.DIPO_NOMBRE) ? dp.DIPO_NOMBRE : "N/A";
            }
            else
                dr["Canton1"] = "N/A";
            ...
            if (datosPacienteActual.COD_PROVINCIA != null)
            {
                ...
                dr["Provincia1"] = !string.IsNullOrEmpty(dp.DIPO_NOMBRE) ? dp.DIPO_NOMBRE : "N/A";
            }
            else
                dr["Provincia1"] = "N/A";
            ...
            dr["Zona"] = "X";
            dr["Telefono"] = datosPacienteActual.DAP_TELEFONO1;
            dr["NArchivo"] = pacienteActual.PAC_HISTORIA_CLINICA.Trim() + "-" + txt_Atencion.Text;
            dr["Celular"] = datosPacienteActual.DAP_TELEFONO2;
            dr["FNacimiento"] = Convert.ToDateTime(pacienteActual.PAC_FECHA_NACIMIENTO).ToString("yyyy-MM-dd");
            DateTime fechaNacimiento = Convert.ToDateTime(pacienteActual.PAC_FECHA_NACIMIENTO);
            ...
            if (estadoCivilPaciente.ESC_CODIGO == 1)
                ...
                dr["Union"] = "X";
            dr["Instruccion"] = !string.IsNullOrEmpty(datosPacienteActual.DAP_INSTRUCCION) ? datosPacienteActual.DAP_INSTRUCCION : "N/A";
            dr["NEstudio"] = !string.IsNullOrEmpty(datosPacienteActualDA.PAC_ESTADO_NIVEDU) ? datosPacienteActualDA.PAC_ESTADO_NIVEDU : "N/A";

            if (pacienteActual.PAC_TIPO_IDENTIFICACION == "C" || pacienteActual.PAC_TIPO_IDENTIFICACION == "R")
                dr["TIdentificacionC"] = "X";
            else if (pacienteActual.PAC_TIPO_IDENTIFICACION == "E" || pacienteActual.PAC_TIPO_IDENTIFICACION == "P")
                dr["TIdentificacionP"] = "X";
            else if (pacienteActual.PAC_TIPO_IDENTIFICACION == "S")
            {
                dr["TIdentificacionSD"] = "X";

            }
            dr["FAdmision"] = Convert.ToDateTime(atencionActual.ATE_FECHA_INGRESO).ToString("yyyy-MM-dd");
            dr["Ocupacion"] = datosPacienteActual.DAP_OCUPACION;
            dr["TEmpresa"] = !string.IsNullOrEmpty(datosPacienteActualDA.PAC_TIP_EMPRESA) ? datosPacienteActualDA.PAC_TIP_EMPRESA : "N/A";
            dr["Seguro"] = txtaseguradora.Text;
            dr["Referido"] = referido.TIR_NOMBRE;
            dr["EnCaso"] = !string.IsNullOrEmpty(pacienteActual.PAC_REFERENTE_NOMBRE) ? pacienteActual.PAC_REFERENTE_NOMBRE : "N/A";
            dr["Parentesco"] = pacienteActual.PAC_REFERENTE_PARENTESCO;
            dr["Direccion1"] = pacienteActual.PAC_REFERENTE_DIRECCION;
            dr["CalleSecundaria"] = datosPacienteActual.DAP_DIRECCION_DOMICILIO2;
            dr["DirReferencia"] = datosPacienteActual.DAP_REFERENCIA;
            dr["Telefono1"] = !string.IsNullOrEmpty(pacienteActual.PAC_REFERENTE_TELEFONO.Trim()) ? pacienteActual.PAC_REFERENTE_TELEFONO.Trim() : "N/A";
            ...
            dr["Institucion"] = !string.IsNullOrEmpty(atencionActual.ATE_INSTITUCION_ENTREGA) ? atencionActual.ATE_INSTITUCION_ENTREGA : "N/A";
            if (dtoAdicional2.nac_etnica != "" && dtoAdicional2.nac_etnica != null)
            {
                NACIONALIDAD_ETNIA ne = Lisnetnias.FirstOrDefault(e => e.NE_CODIGO == Convert.ToInt32(dtoAdicional2.nac_etnica));
                dr["NEtnia"] = ne.NE_DESCRIPCION;
            }
            else
            {
                dr["NEtnia"] = "N/A";
            }
            if (dtoAdicional2.pueblo != "" && dtoAdicional2.pueblo != null)
            {
                NACIONALIDAD_ETNIA pueblo = Lisnetnias.FirstOrDefault(e => e.NE_CODIGO == Convert.ToInt32(dtoAdicional2.pueblo));
                dr["Pueblo"] = pueblo.NE_DESCRIPCION;
            }
            else
            {
                dr["Pueblo"] = "N/A";
            ...
            dr["Hora"] = Convert.ToDateTime(atencionActual.ATE_FECHA_INGRESO).ToString("HH:mm");
            DateTime fechaA = Convert.ToDateTime(txtFechaI.Text);
            dr["FechaAtencion"] = fechaA.ToString("yyyy-MM-dd");
            ...
            dr["CLlMotivo"] = emergenciaActual.EMER_CL_MOTIVO;
            if (emergenciaActual.EMER_CL_ESTABLE == 1)
                dr["CLlEstable"] = "X";
            if (emergenciaActual.EMER_CL_INESTABLE == 1)
                dr["CLlInstable"] = "X";
            if (emergenciaActual.EMER_CL_FALLECIDO == 1)
                dr["CLlFallecido"] = "X";

            if (emergenciaActual.EMER_SIN_VIT == 1)
                dr["SVitales"] = "X";
            ...
            //if ((bool)emergenciaActual.EMER_TRAUMA)
            // {
            dr["FechaHora"] = Convert.ToDateTime(emergenciaActual.EMER_FECHA_EVENTO).ToString("yyyy-MM-dd");
            dr["Hora2"] = Convert.ToDateTime(emergenciaActual.EMER_FECHA_EVENTO).ToString("HH:mm");
            dr["Lugar"] = cmb_LugarEvento.Text;
            dr["DireccionE"] = emergenciaActual.EMER_DIRECCION_EVENTO;
            if (emergenciaActual.EMER_ACT_TRA == 1)
                dr["ActTra"] = "X";
            if (emergenciaActual.EMER_VIO_ARM == 1)
                dr["VioArm"] = "X";
            if (emergenciaActual.EMER_INT_ALC == 1)
                dr["IntAlc"] = "X";
            if (emergenciaActual.EMER_CAIDA == 1)
                dr["Caidas"] = "X";
            if (emergenciaActual.EMER_VIO_PUN == 1)
                dr["VioPun"] = "X";
            if (emergenciaActual.EMER_INT_ALI == 1)
                dr["IntAli"] = "X";
            if (emergenciaActual.EMER_QUEMADURA == 1)
                dr["Quemaduras"] = "X";
            if (emergenciaActual.EMER_VIO_RINA == 1)
                dr["VioRin"] = "X";
            if (emergenciaActual.EMER_INT_DRO == 1)
                dr["IntDro"] = "X";
            if (emergenciaActual.EMER_MORDEDURA == 1)
                dr["Mordeduras"] = "X";
            if (emergenciaActual.EMER_VIO_FAM == 1)
                dr["VioFam"] = "X";
            if (emergenciaActual.EMER_INH_GAS == 1)
                dr["InhGas"] = "X";
            if (emergenciaActual.EMER_INH_GAS == 1)
                dr["InhGas"] = "X";
            if (emergenciaActual.EMER_AHOGAMIENTO == 1)
                dr["Ahogamientos"] = "X";
            if (emergenciaActual.EMER_PRE_FIS == 1)
                dr["PreFis"] = "X";
            if (emergenciaActual.EMER_OTR_INT == 1)
                dr["OtrInt"] = "X";
            if (emergenciaActual.EMER_CUE_EXT == 1)
                dr["CueExt"] = "X";
            if (emergenciaActual.EMER_PRE_PSI == 1)
                dr["PrePsi"] = "X";
            if (emergenciaActual.EMER_PICADURA == 1)
                dr["Picaduras"] = "X";
            if (emergenciaActual.EMER_APLASTAMIENTO == 1)
                dr["Aplastamientos"] = "X";
            if (emergenciaActual.EMER_PRE_SEX == 1)
                dr["PreSex"] = "X";
            if (emergenciaActual.EMER_ENVENENAMIENTO == 1)
                dr["Envenenamientos"] = "X";
            if (emergenciaActual.EMER_OTR_ACC == 1)
                dr["OtrAcc"] = "X";
            if (emergenciaActual.EMER_NOTIFICACION == 1)
                dr["Notificaciones"] = "X";
            if (emergenciaActual.EMER_ANAFILAXIA == 1)
                dr["Anafilaxia"] = "X";
            if (chk_CustodiaPolicial.Checked)
                dr["Custodia"] = "X";
            else
                dr["CusPolNo"] = "X";
            if (emergenciaActual.EMER_GRU_PRIO == 1)
                dr["GPrioritarioSi"] = "X";
            else
                dr["GPrioritarioNo"] = "X";
            dr["DPrioritario"] = emergenciaActual.EMER_PRIORITARIO;
            ...
            if (emergenciaActual.EMER_ALIENTO_ETIL == true)
            {
                dr["AEtilico"] = "X";
            }
            ...
            foreach (var item in AntecedentesPF)
            {
                ...
                else if (item.HCC_CODIGO == 903)
                {
                    dr["Habitos"] = "X";
                    num = 8;
                }
                else if (item.HCC_CODIGO == 904)
                {
                    dr["Familiares"] = "X";
                    num = 9;
                }
            ...
            if (emergenciaActual.EMER_SIN_VIT != 1)
            {
                ...
                if (emergenciaActual.EMER_PESO == "" || emergenciaActual.EMER_PESO == "0" || emergenciaActual.EMER_PESO.ToString() == "0.00")
                    dr["Peso"] = "";
                else
                    dr["Peso"] = emergenciaActual.EMER_PESO;
                if (emergenciaActual.EMER_TALLA == "" || emergenciaActual.EMER_TALLA == "0" || emergenciaActual.EMER_TALLA.ToString() == "0.00")
                    dr["Talla"] = "";
                else
                ...
                if (cmb_ReacPIValor.SelectedIndex == 0)
                    dr["PIzquierdo"] = "No";
                if (emergenciaActual.EMER_GLICEMIA_CAPILAR == 0)
                    dr["Capilar"] = "";
                else
                    dr["Capilar"] = emergenciaActual.EMER_GLICEMIA_CAPILAR;
                dr["Oxigeno"] = emergenciaActual.EMER_SATURA_OXI;
                if (emergenciaActual.EMER_PERIMETRO.ToString() == "0.00" || emergenciaActual.EMER_PERIMETRO.ToString() == "0")
                    dr["Permitro"] = "";
                else
                    dr["Permitro"] = emergenciaActual.EMER_PERIMETRO;
                if (emergenciaActual.EMER_LLE_CAP == "" || emergenciaActual.EMER_LLE_CAP == "0" || emergenciaActual.EMER_LLE_CAP.ToString() == "0.00")
                {
                    dr["LCapilar"] = "";
                }
                else
                {
                    dr["LCapilar"] = Convert.ToInt32(Convert.ToDouble(emergenciaActual.EMER_LLE_CAP));
                }
            }
            #endregion
            ...
            foreach (var item in examenes)
            {
                ...
                if (item.HCC_CODIGO == 894)
                {
                    dr["EFOjos"] = "X";
                    num = 3;
                    detalle = " OJOS";
                }
                if (item.HCC_CODIGO == 896)
                {
                    dr["EFOidos"] = "X";
                    num = 4;
                    detalle = " OIDOS";
                }
                if (item.HCC_CODIGO == 902)
                {
                    dr["EFNariz"] = "X";
                    num = 5;
                    detalle = " NARIZ";
                }
                if (item.HCC_CODIGO == 897)
                {
                    dr["EFBoca"] = "X";
                    num = 6;
                    detalle = " BOCA";
                }
                if (item.HCC_CODIGO == 895)
                {
                    dr["EFOFaringe"] = "X";
                    num = 7;
                    detalle = " OROFARINGE";
                ...
                if (item.HCC_CODIGO == 898)
                {
                    dr["EFAxiMamas"] = "X";
                    num = 9;
                    detalle = " AXILAS-MAMAS";
                }
                ...
                if (item.HCC_CODIGO == 842)
                {
                    dr["Columna"] = "X";
                    num = 12;
                    detalle = " COLUMNA VERTEBRAL";
                }
                if (item.HCC_CODIGO == 899)
                {
                    dr["EFIngle"] = "X";
                    num = 13;
                    detalle = " INGLE-PERINÉ";
                }
                if (item.HCC_CODIGO == 900)
                {
                    dr["EFMSuperiores"] = "X";
                    num = 14;
                    detalle = " MIEMBROS SUPERIORES";
                }
                if (item.HCC_CODIGO == 901)
                {
                    dr["EFMInferiores"] = "X";
                    num = 15;
                    detalle = " MIEMBROS INFERIORES";

                }


                eFisico = eFisico + detalle + ": " + item.EEFD_DESCRIPCION;
            ...
            ///
            if (txt_Gesta.Text != "0" && txt_Gesta.Text != "")
            {
                dr["Gesta"] = txt_Gesta.Text;
                dr["Partos"] = txt_Partos.Text;
                dr["Aborto"] = txt_Abortos.Text;
                dr["Cesarea"] = txt_Cesareas.Text;
                if (dtp_ultimaMenst11.Checked == true)
                {
                    dr["FMestruacion"] = dtp_ultimaMenst11.Value.ToString().Substring(0, 10);
                }
                if (txt_SemanaG.Text == "0" || txt_SemanaG.Text == "0.00")
                    dr["SGestacion"] = "";
                else
                    dr["SGestacion"] = txt_SemanaG.Text;
                if (chk_MovimientoF.Checked == true)
                    dr["MFetal"] = "X";
                //dr["MFetal"] = Convert.ToBoolean(eObst.EOBT_MOV_FETAL);
                if (txt_FrecCF.Text == "0" || txt_FrecCF.Text == "0.00")
                    dr["FFetal"] = "";
                else
                    dr["FFetal"] = txt_FrecCF.Text;
                if (chk_MembranaS.Checked == true)
                    dr["MRotas"] = "X";

                //dr["MRotas"] = Convert.ToBoolean(eObst.EOBT_MEM_SROTAS);
                //dr["Tiempo"] = txt_Tiempo.Text;
                dr["Tiempo"] = (txt_Tiempo.Text == "0") ? "" : txt_Tiempo.Text;
                //dr["AUterina"] = txt_AltU.Text;
                dr["AUterina"] = (txt_AltU.Text == "0") ? "" : txt_AltU.Text;
                dr["Presentacion"] = (txt_Presentacion.Text == "0") ? "" : txt_Presentacion.Text;
                //dr["Presentacion"] = txt_Presentacion.Text;
                dr["Dilatacion"] = (txt_Dilatacion.Text == "0") ? "" : txt_Dilatacion.Text;
                dr["Borramiento"] = (txt_Borramiento.Text == "0") ? "" : txt_Borramiento.Text;
                //dr["Dilatacion"] = txt_Dilatacion.Text;
                //dr["Borramiento"] = txt_Borramiento.Text;
                dr["Plano"] = txt_Plano.Text;
                if (chk_PelvisU.Checked == true)
                    dr["oUtil"] = "X";
                if (chk_SangradoV.Checked == true)
                    dr["SVaginal"] = "X";


                //dr["oUtil"] = Convert.ToBoolean(eObst.EOBT_PELVIS_UTIL);
                //dr["SVaginal"] = Convert.ToBoolean(eObst.EOBT_SANGRADO_VAGINAL);
                // dr["Contracciones"] = txt_Contracciones.Text;
                dr["Contracciones"] = (txt_Contracciones.Text == "0") ? "" : txt_Contracciones.Text;
                dr["EObstetrica"] = txt_EmergenciaObt.Text;
                ///
            }
            else
            ...
            {
                dr1 = dts.Tables["PlanTratamiento"].NewRow();
                dr1["Medicamento"] = item.ETRA_DESCRIPCION;
                dr1["Via"] = item.VIA;
                dr1["Dosis"] = item.DOSIS;
                dr1["Posologia"] = item.EMER_POSOLOGIA;
                dr1["Dia"] = item.DIAS;
                dts.Tables["PlanTratamiento"].Rows.Add(dr1);
            }
            ...
            #region 14) ALTA
            if (emergenciaActual.EMER_ALT_DEF == 1)
                dr["AltaDef"] = "X";
            dr["ObsExaFis"] = emergenciaActual.EMER_OBS_EXA_FIS;
            ...
            if ((bool)emergenciaActual.EMER_OBS_ALTA)
                dr["Observacion14"] = "X";
            if ((bool)emergenciaActual.EMER_INTER)
                dr["Internacion"] = "X";
            if (emergenciaActual.EMER_SER_REF.ToString().Length > 3)
            {
                dr["Referencia"] = "X";
            }
            ...
            //if (emergenciaActual.EMER_MUERTO_EMER != null || emergenciaActual.EMER_MUERTO_EMER == false)
            if (emergenciaActual.EMER_MUERTO_EMER == true)
            {
            ...
            {
                if (txt_DiasInc.Text == "0" || txt_DiasInc.Text == "")
                {
                    dr["Dias"] = "";
                }
                else
            ...
            dr["ObsEgr"] = emergenciaActual.EMER_OBS_EGR;
            if (emergenciaActual.EMER_HOSPITALIZACION == 1)
                dr["Hospitalizacion"] = "X";
            if (emergenciaActual.EMER_DERIVACION == 1)
                dr["Derivacion"] = "X";
            if (emergenciaActual.EMER_REF_INV == 1)
                dr["ReferenciaInv"] = "X";
            #endregion

            #region PIE
            dr["Fecha"] = Convert.ToDateTime(emergenciaActual.EMER_FECHA_E).ToString("yyyy-MM-dd");
            dr["Hora14"] = Convert.ToDateTime(emergenciaActual.EMER_FECHA_E).ToShortTimeString();
            MEDICOS musuario = NegMedicos.recuperarMedicoID_Usuario(Convert.ToInt32(emergenciaActual.ID_USUARIO));
            if (musuario != null)
            {
                dr["Medico"] = musuario.MED_APELLIDO_PATERNO;
                dr["MedicoAM"] = musuario.MED_APELLIDO_MATERNO;
                dr["MedicoPN"] = musuario.MED_NOMBRE1;
                dr["MCodigo"] = musuario.MED_RUC.Substring(0, 10);
            }
            else
            {
                dr["Medico"] = "N/A";
            ...
            His.Formulario.frmReportes reporte = new His.Formulario.frmReportes(1, "Hoja 008New", dts);
            reporte.Show();
        }
        ...
        private void cmb_Ocular_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void cmb_Verbal_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (cmb_Ocular.SelectedIndex != -1)
            {
                if (cmb_Verbal.SelectedIndex != -1)
        ...
        private void cmb_Motora_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (cmb_Ocular.SelectedIndex != -1)
            {
                if (cmb_Verbal.SelectedIndex != -1)
        ...
        private void chkAnafilaxia_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void txt_PresionA1_Validated(object sender, EventArgs e)
        {
        ...
        private void txt_PresionA2_TextChanged_1(object sender, EventArgs e)
        {
            if (txt_PresionA2.Text == "" || !NegUtilitarios.ValidaPrecion2(Convert.ToDouble(txt_PresionA2.Text)))
            {
                txt_PresionA2.Text = "0";
        ...
        private void txt_FResp_Validated(object sender, EventArgs e)
        {
        ...
        private void txt_SaturaO_Validated(object sender, EventArgs e)
        {
            decimal satura = 0;
            if (txt_SaturaO.Text == "")
            {
            ...
            {
                satura = Convert.ToDecimal(txt_SaturaO.Text);
            }
            if (satura < 30 || satura > 100)
            {
                txt_SaturaO.Focus();
        ...
        private void txt_PesoKG_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void txt_PesoKG_Validated(object sender, EventArgs e)
        {


        }

        private void txt_Talla_TextChanged_1(object sender, EventArgs e)
        {
            double talla1 = 0;
        ...
        private void txt_Glicemia_Validating(object sender, CancelEventArgs e)
        {
            if (txt_Glicemia.Text == "")
            {
                txt_Glicemia.Text = "0";
        ...
        private void txtLleCap_Validated(object sender, EventArgs e)
        {
            if (txtLleCap.Text == "")
            {
                txtLleCap.Text = "0";
        ...
        private void txt_PerimetroC_Validated(object sender, EventArgs e)
        {
            if (txt_PerimetroC.Text == "")
            {
                txt_PerimetroC.Text = "0";
        ...
        private void txt_TBucal_Validated(object sender, EventArgs e)
        {

        }

        private void txt_TAxilar_Validated(object sender, EventArgs e)
        {

        }

        private void chkSinCon_CheckedChanged(object sender, EventArgs e)
        {
            if (chkSinCon.Checked == true)
            {
                txt_PresionA1.Text = "0";
                txt_PresionA2.Text = "0";
                txt_FCardiaca.Text = "0";
        ...
        private void chkAltDef_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void chkHospitalizacion_CheckedChanged(object sender, EventArgs e)
        {
            if (chkHospitalizacion.Checked == true)
            {
                txt_servicioReferencia.Enabled = true;
                txt_Establecimiento.Enabled = true;
                txt_servicioReferencia.ReadOnly = false;
        ...
        private void chkRefInv_CheckedChanged(object sender, EventArgs e)
        {
            if (chkRefInv.Checked == true)
            {
                txt_servicioReferencia.Enabled = true;
                txt_Establecimiento.Enabled = true;
                txt_servicioReferencia.ReadOnly = false;
        ...
        private void chkDerivacion_CheckedChanged(object sender, EventArgs e)
        {
            if (chkDerivacion.Checked == true)
            {
                txt_servicioReferencia.Enabled = true;
                txt_Establecimiento.Enabled = true;
                txt_servicioReferencia.ReadOnly = false;
        ...
        private void txt_TBucal_KeyDown_1(object sender, KeyEventArgs e)
        {
            //if (e.KeyCode == Keys.Enter || e.KeyCode == Keys.Tab)
            //{
            //    //txt_TAxilar.Focus();
        ...
        private void txt_TAxilar_KeyDown_1(object sender, KeyEventArgs e)
        {
            //if (e.KeyCode == Keys.Enter || e.KeyCode == Keys.Tab)
            //{
            //    if (txt_TAxilar.Text != "0")
        ...
        private void txtScore_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (char.IsDigit(e.KeyChar))
            {
                // Obtener el valor ingresado como un número
                int num = int.Parse(txtScore.Text + e.KeyChar);

                // Permitir solo números del 0 al 24
                if (num >= 0 && num <= 24)
                {
                    e.Handled = false;
                }
        ...
        private void txt_DiamPDV_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_DiamPIV_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_Glicemia_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_PresionA1_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            MiMetodoNumeros(sender, e);
            if (char.IsControl(e.KeyChar))
            {
        ...
        private void txt_SemanaG_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txtScore_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_PresionA2_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_FCardiaca_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_FResp_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_SaturaO_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_TBucal_Validating_1(object sender, CancelEventArgs e)
        {
            if (txt_TBucal.Text != "" || txt_TBucal.Text == "0")
            {
                if (!NegUtilitarios.ValidaTemperatura(Convert.ToDecimal(txt_TBucal.Text)))
                {
                    txt_TBucal.Text = NegParametros.RecuperaValorParSvXcodigo(60).ToString();
                    txtIMCorporal.Focus();
                    return;
                }
        ...
        private void txt_TAxilar_Validating_1(object sender, CancelEventArgs e)
        {
            if (txt_TAxilar.Text != "" || txt_TAxilar.Text == "0")
            {
                if (!NegUtilitarios.ValidaTemperatura(Convert.ToDecimal(txt_TAxilar.Text)))
                {
                    txt_TAxilar.Text = NegParametros.RecuperaValorParSvXcodigo(60).ToString();
                    txtIMCorporal.Focus();
                    return;
                }
            }
        ...
        private void txt_TBucal_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            txt_TAxilar.Text = "0";
            ...
            else if (char.IsControl(e.KeyChar)) // Permitir teclas de control (como borrar)
            {
                e.Handled = false;
            }
            else
        ...
        private void txt_TAxilar_KeyPress_1(object sender, KeyPressEventArgs e)
        {
        ...
        private void txt_Gesta_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_Partos_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_Abortos_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_Cesareas_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_AltU_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_Dilatacion_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_Borramiento_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_Contracciones_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_Plano_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void txt_PerimetroC_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            else if (char.IsControl(e.KeyChar) || e.KeyChar == (char)Keys.Back) // Permitir teclas de control (como borrar)
            {
                e.Handled = false;
            }
            else
        ...
        private void txtLleCap_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (char.IsControl(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void chbPiel_CheckedChanged(object sender, EventArgs e)
        {
            if (chbPiel.Checked == true)
            {
        ...
        private void chbOjos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbOjos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
        ...
        private void chbOidos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbOidos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
        ...
        private void chbNariz_CheckedChanged(object sender, EventArgs e)
        {
            if (chbNariz.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
        ...
        private void chbBoca_CheckedChanged(object sender, EventArgs e)
        {
            if (chbBoca.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
        ...
        private void chbOrofaringe_CheckedChanged(object sender, EventArgs e)
        {
            if (chbOrofaringe.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
        ...
        private void chbAxilas_CheckedChanged(object sender, EventArgs e)
        {
            if (chbAxilas.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
        ...
        private void chbColumna_CheckedChanged(object sender, EventArgs e)
        {
            if (chbColumna.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "COLUMNA")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbIngle_CheckedChanged(object sender, EventArgs e)
        {
            if (chbIngle.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "INGLE PERINE")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbInferior_CheckedChanged(object sender, EventArgs e)
        {
            if (chbInferior.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_ExamenFisico.Rows)
                {
                    if (filas.Cells[1].Value != null)
        ...
        private void chbAlergicos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbAlergicos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "ALERGICO")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbClinicos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbClinicos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "CLINICO")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbGinecologicos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbGinecologicos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "GINECOLÓGICO")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbTraumatologicos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbTraumatologicos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "TRAUMATÓGICO")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbPediatricos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbPediatricos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "PEDIATRICOS")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbQuirurgicos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbQuirurgicos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "QUIRÚRGICO")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbFarmacologicos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbFarmacologicos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "FARMACOLÓGICO")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbHabitos_CheckedChanged(object sender, EventArgs e)
        {
            if (chbHabitos.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "HABITOS")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbFamiliares_CheckedChanged(object sender, EventArgs e)
        {
            if (chbFamiliares.Checked == true)
            {
                foreach (DataGridViewRow filas in dtg_antec_personales.Rows)
                {
                    if (filas.Cells[1].Value != null)
                    {
                        if (filas.Cells[1].Value.ToString() == "FAMILIARES")
                            return;
                    }
                }
                DataGridViewRow fila = new DataGridViewRow();
        ...
        private void chbOtroP_CheckedChanged(object sender, EventArgs e)
        {
